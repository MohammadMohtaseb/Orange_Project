    ...
    <main>
        <div class="containerSa">
            ...
            <div class="breadcrumb">
                ...
                <a href="{{ route('watch.academies') }}">{{ $academy->name }}</a> &gt;
                <a href="{{ route('academy.showCohorts', ['academy' => $academy->id]) }}">Cohort</a> &gt;
                <a href="{{ route('watch.cohorts', ['cohort' => $cohort->id, 'academy' => $academy->id]) }}" style="color: #FF7900">
