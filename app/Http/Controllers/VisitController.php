...
class VisitController extends Controller
{
    ...
    public function showCohortWithStudents($cohort, $academy)
    {
        $cohort = Cohort::with('students')->findOrFail($cohort);
        $academy = Academy::findOrFail($academy);
        $students = $cohort->students;
        return view('students', compact('cohort', 'academy','students'));
    }
}
